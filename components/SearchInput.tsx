...
export const SearchInput = ({ value, onChange, isLoading }: SearchInputProps) => {
  return (
    <div className="relative w-full max-w-2xl group">
      <div className="absolute inset-y-0 left-0 flex items-center pl-6 pointer-events-none text-gray-400 group-focus-within:text-gemini-blue transition-colors duration-300">
